const menuOptions = [
    ...
    { name: 'BigVegano', price: 55, vegan: true, src: './img/xvegan.png' },
    { name: 'X-Vegan', price: 45, vegan: true, src: './img/monstruoso-veegan.png' },
    
]

///e que a lista está sendo atualizada corretamente no documento HTML.///